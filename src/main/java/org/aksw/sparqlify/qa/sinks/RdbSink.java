...
public class RdbSink implements MeasureDataSink {
    ...
    protected final String nodeTripleTbl = "node_triple";
    protected final String nodeTbl = "node";
    protected final String quadTbl = "quad";
    protected final String tripleTbl = "triple";
    protected final String varTbl = "variable";
    protected final String viewDefTbl = "view_definition";

    protected final String md2nodeTbl = "measure_datum__node";
    protected final String md2nodeTripleTbl = "measure_datum__node_triple";
    protected final String md2quadTbl = "measure_datum__quad";
    protected final String md2tripleTbl = "measure_datum__triple";
    protected final String md2varTbl  = "measure_datum__variable";
    protected final String md2viewDefTbl = "measure_datum__view_definition";
    protected final String trpl2quadTbl = "triple__quad";
    protected final String trpl2viewDefTbl = "triple__view_definition";
    protected final String vd2quadTbl = "view_definition__quad";
    protected final String vd2varTbl = "view_definition__variable";
    ...
    protected void emptyDb() throws SQLException {
        List<String> redoTblNames = emptyTblsOrReturnFailed(tableNames);

        while (redoTblNames.size() > 0) {
            redoTblNames = emptyTblsOrReturnFailed(redoTblNames);
        }

    }

    private List<String> emptyTblsOrReturnFailed(List<String> tblsNames) throws SQLException {
        List<String> redoTblNames = new ArrayList<String>();
        for (String tblName : tblsNames) {
            try {
                conn.createStatement().executeUpdate(
                        "DELETE FROM " + tblName + ";");
            } catch (JdbcSQLException e) {
                redoTblNames.add(tblName);
            }
        }
